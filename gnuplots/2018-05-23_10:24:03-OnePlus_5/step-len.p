  ...
  set ylabel "y"
plot \
 "static-step-history.dat" using 1:2 with linespoints title "static step vector", \
 "dynamic-step-history.dat" using 1:2 with linespoints title "dynamic step vector"
