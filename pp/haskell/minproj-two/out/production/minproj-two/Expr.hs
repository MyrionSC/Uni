...
--reduce (Add (Poly (Parents (Add (Poly (Var e1)) (Poly (Var e2))))) (Poly (Var e3))) = Add (Poly (Var e1)) (Poly (Parents (Add (Poly (Var e2)) (Poly (Var e3)))))
...
--Mult (Poly (Parents (Mult (Poly (Var "e1")) (Poly (Var "e2"))))) (Poly (Var "e3"))
--Mult (Mult (Poly (Var "e1")) (Poly (Var "e2"))) (Poly (Var "e3"))
